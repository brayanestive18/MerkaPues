...
public class TabFragment extends Fragment {
    ...
    private String nameTab1 = "Bonos";
    private String nameTab2 = "Promociones del Dia";
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        numberTabs = 3;
        zonesList = new Fragment[3];

        zonesList[0] = new BonosFragment();
        zonesList[1] = new DayPromoFragment();
